...
import { MPHelpSupportPage } from '@pages/MPHelpSupportPage';
...
const test = baseTest.extend<{
  ...
  mpHelpSupportPage: MPHelpSupportPage;
  ...
  mpHelpSupportPage: async ({ page }, use) => {
    await use(new MPHelpSupportPage(page));
  },
});
